...
namespace EventApiTests.Services
{
    public class OrderServiceTests
    {
        ...
        public async Task GetOrderAsync_ShouldReturnOrderInfo_WhenOrderExists()
        {
            ...
            result.CartIdentifier.Should().Be(cartIdentifier);
        }
        ...
        public async Task GetOrderAsync_ShouldThrowException_WhenOrderNotFound()
        {
            ...
            // Act & Assert
            await _orderService
                .Invoking(s => s.GetOrderAsync(cartIdentifier))
                .Should()
                .ThrowAsync<NullValueEntitySearchExceprion>();
        }
        ...
        public async Task AddNewTicketToOrderAsync_ShouldThrowException_WhenTicketNotFound()
        {
            ...
            // Act & Assert
            await _orderService
                .Invoking(s => s.AddNewTicketToOrderAsync(cartIdentifier, ticketData))
                .Should()
                .ThrowAsync<NullValueEntitySearchExceprion>();
        }
        ...
        public async Task DeletTicketAsync_ShouldThrowException_WhenTicketNotFound()
        {
            ...
            // Act & Assert
            await _orderService
                .Invoking(s => s.DeletTicketAsync(cartId, eventId, seatId))
                .Should()
                .ThrowAsync<NullValueEntitySearchExceprion>();
        }
        ...
        public async Task MooveTicketsInCartToBookedStatusAsync_ShouldThrowException_WhenPurchaseNotFound()
        {
            ...
            // Act & Assert
            await _orderService
                .Invoking(s => s.MooveTicketsInCartToBookedStatusAsync(cartIdentifier))
                .Should()
                .ThrowAsync<NullValueEntitySearchExceprion>();
        }
